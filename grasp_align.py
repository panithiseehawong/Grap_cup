...
FPS_SMOOTHING = 0.90 
MAX_LOOP_FPS = 60  # set 60.0, 30.0, 20.0, or 0/None to disable
...
def draw_overlay(display, data, cup_box=None, cup_center=None, image_center_x=None, jog_info=None, fps_value=None):
...
while True:
    ...
    last_fps_time, fps_value = update_smoothed_fps(last_fps_time, fps_value)
